...
8.Si `numero 1` > `numero 2` entonces:
        
        i. temporal = 'numero 1' 
        ii. 'numero 1' = 'numero 2'
        iii. 'numero 2' = temporal

9. finsin

10. Mostrar “ numero ordenados”

11. Mostrar “numero 1 : ”,numero 1'

12. Mostrar “ numero 2 : ”,'numero 2'
...
6.velocidad ms = (velociad kmh * 1000) / 3600
...
3. Cree un algoritmo que le pregunte al usuario por el sexo de 6 personas, ingresando 1 si es mujer o 2 si es hombre, y muestre al final el porcentaje de mujeres y hombres.
    ...
    4.Para i desde1 en el rango de 6:
     ...
     8.sino
        ...
        si sexo = 2
          ...
          sino
             ...
             i.mostrar “ entrada invalida. por favor ingrese 1 o 2.”
    ...
    12.porecentanje_mujeres = (mujer / 6) * 100
